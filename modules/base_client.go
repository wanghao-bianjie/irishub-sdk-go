...
func (base *baseClient) BuildAndSendMulti(msg []sdk.Msg, baseTx sdk.BaseTx, names []string) (sdk.ResultTx, sdk.Error) {
	txByte, ctx, err := base.buildTxMulti(msg, baseTx, names)
	if err != nil {
		return sdk.ResultTx{}, err
	}
